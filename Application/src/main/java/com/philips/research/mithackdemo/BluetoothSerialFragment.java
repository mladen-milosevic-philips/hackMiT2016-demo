...
package com.philips.research.mithackdemo;
 ...
 */
public class BluetoothSerialFragment extends Fragment implements SensorEventListener {

    private static final String TAG = "BluetoothSerialFragment";
    ...
    public final void onSensorChanged(SensorEvent event) {
        ...
        if (mChatService.getState() == BluetoothSerialService.STATE_CONNECTED) {
            ...
            send[4] = ByteBuffer.allocate(4).putFloat(accX).array()[0];

            send[5] = ByteBuffer.allocate(4).putFloat(accY).array()[3];
            send[6] = ByteBuffer.allocate(4).putFloat(accY).array()[2];
            send[7] = ByteBuffer.allocate(4).putFloat(accY).array()[1];
            send[8] = ByteBuffer.allocate(4).putFloat(accY).array()[0];

            send[9] = ByteBuffer.allocate(4).putFloat(accZ).array()[3];
            send[10] = ByteBuffer.allocate(4).putFloat(accZ).array()[2];
            send[11] = ByteBuffer.allocate(4).putFloat(accZ).array()[1];
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        accXvalue = (TextView) view.findViewById(R.id.accX_value);
        accYvalue = (TextView) view.findViewById(R.id.accY_value);
        accZvalue = (TextView) view.findViewById(R.id.accZ_value);
